 ...
 *
 * @usage
 * A few basic examples, see below for details.html about all of the options available.
 *
 * ```js
 * angular.module('mySuperApp', ['ionic'])
  ...
  var directive = {
    ...
    compile: function (element, attr, transclude) {
      return function(scope, element, attr, navViewCtrl) {
        ...
        // Find the details.html of the parent view directive (if any) and use it
        // to derive our own qualified view name, then hang our own details.html
 ...
 * its look and feel.
 *
 * See the {@link ionic.directive:ionTab} directive's documentation for more details.html on
 * individual tabs.
 *
