...
forEach('input,select,option,textarea,button,form,details.html'.split(','), function(value) {
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
     ...
     *    provides Strict Contextual Escaping for details.html.
...
function $IntervalProvider() {
  this.$get = ['$rootScope', '$window', '$q',
    ...
    var intervals = {};
      ...
      * appropriate moment.  See the example below for more details.html on how and when to do this.
      * </div>
      *
...
function $LocationProvider(){
   ...
   * details.html about event object. Upon successful change
 ...
 *
 * For the general details.html about this service in Angular, read the main page for {@link ng.$sce
...
function $SceProvider() {
   ...
   * is purely an implementation details.html.
   *
 ...
 * @example
     <doc:example>
       <doc:source>
         ...
         <details.html id="details.html" ng-open="open">
            <summary>Show/Hide me</summary>
         </details.html>
       </doc:source>
       <doc:protractor>
         it('should toggle open', function() {
           expect(element(by.id('details.html')).getAttribute('open')).toBeFalsy();
           element(by.model('open')).click();
           expect(element(by.id('details.html')).getAttribute('open')).toBeTruthy();
         });
       </doc:protractor>
     </doc:example>
 *
 ...
 * @example Example that demonstrates basic bindings via ngClass directive.
   ...
   to view the step by step details.html of {@link ngAnimate.$animate#methods_addclass $animate.addClass} and
